...
a persistence unit "evaluacionRamirezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluacionRamirez/pom.xml":
...
artifact ("evaluacionRamirez.war") is already built. You can build
